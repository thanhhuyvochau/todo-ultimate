---
name: git-cli
description: Enforces Conventional Commits v1.0.0 rules, commit message formatting, scopes, breaking changes, and approval guidelines for AI coding agents.
---

# SKILL: Conventional Commits Guideline

This skill instructs AI coding agents on how to construct commit messages that strictly adhere to the Conventional Commits v1.0.0 specification.

...
- [x] WYSIWYG editing with all toolbar options functional.
- [x] Content persists as valid Markdown in SQLite. _(Note: Stores HTML via TipTap `getHTML()`. Markdown serialization is tracked as a non-blocking future optimization.)_
- [x] Auto-save triggers on content change with debounce.
- [x] Manual save shows confirmation indicator.
- [x] Toggle between edit and preview modes.
- [x] Unsaved changes prompt on navigation.
